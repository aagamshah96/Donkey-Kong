...
if __name__=="__main__":
	...
	def game_loop():
		...
		keys = pygame.key.get_pressed()
	    	if keys[pygame.K_LEFT] and ((objects.A.rect.y>=objects.D.height+80-90 and objects.A.rect.y<=objects.D.height+80-70) or (objects.A.rect.y>=settings.dheight*0.4-90 and objects.A.rect.y<=settings.dheight*0.4-70) or (objects.A.rect.y>=settings.dheight*0.6-90 and objects.A.rect.y<=settings.dheight*0.6-70) or (objects.A.rect.y>=settings.dheight*0.8-90 and objects.A.rect.y<=settings.dheight*0.8-70) or (objects.A.rect.y>=settings.dheight-90 and objects.A.rect.y<=settings.dheight-72)):
			objects.A.rect.x -= 2
			if settings.jump==1:
				settings.left=1
			objects.A.imgchange('mariowalk2.png')
	
		if keys[pygame.K_RIGHT] and ((objects.A.rect.y>=objects.D.height+80-90 and objects.A.rect.y<=objects.D.height+80-70) or (objects.A.rect.y>=settings.dheight*0.4-90 and objects.A.rect.y<=settings.dheight*0.4-70) or (objects.A.rect.y>=settings.dheight*0.6-90 and objects.A.rect.y<=settings.dheight*0.6-70) or (objects.A.rect.y>=settings.dheight*0.8-90 and objects.A.rect.y<=settings.dheight*0.8-70) or (objects.A.rect.y>=settings.dheight-90 and objects.A.rect.y<=settings.dheight-72)):
			objects.A.rect.x += 2
			objects.A.imgchange('mariowalk.png')
			if settings.jump==1:
				settings.right=1

		if keys[pygame.K_UP] and ((objects.A.rect.x>settings.Allowed[0]-30 and objects.A.rect.x<settings.Allowed[0]+50 and objects.A.rect.y>settings.Allowed[1]-objects.A.height-30 and objects.A.rect.y<settings.Allowed[1]+50) or (objects.A.rect.x>settings.Allowed[2]-30 and objects.A.rect.x<settings.Allowed[2]+50 and objects.A.rect.y>settings.Allowed[3]-objects.A.height-30 and objects.A.rect.y<settings.Allowed[3]+50) or (objects.A.rect.x>settings.Allowed[4]-30 and objects.A.rect.x<settings.Allowed[4]+50 and objects.A.rect.y>settings.Allowed[5]-objects.A.height-30 and objects.A.rect.y<settings.Allowed[5]+50) or (objects.A.rect.x>settings.Allowed[6]-30 and objects.A.rect.x<settings.Allowed[6]+50 and objects.A.rect.y>settings.Allowed[7]-objects.A.height-20 and objects.A.rect.y<settings.Allowed[7]+50)):
			objects.A.rect.y-=1
			#A.imgchange('marioback.png')

		if keys[pygame.K_DOWN] and ((objects.A.rect.x>settings.Allowed[0]-30 and objects.A.rect.x<settings.Allowed[0]+50 and objects.A.rect.y>settings.Allowed[1]-objects.A.height-50 and objects.A.rect.y<settings.Allowed[1]+40) or (objects.A.rect.x>settings.Allowed[2]-30 and objects.A.rect.x<settings.Allowed[2]+50 and objects.A.rect.y>settings.Allowed[3]-objects.A.height-50 and objects.A.rect.y<settings.Allowed[3]+40) or (objects.A.rect.x>settings.Allowed[4]-30 and objects.A.rect.x<settings.Allowed[4]+50 and objects.A.rect.y>settings.Allowed[5]-objects.A.height-50 and objects.A.rect.y<settings.Allowed[5]+40) or (objects.A.rect.x>settings.Allowed[6]-30 and objects.A.rect.x<settings.Allowed[6]+50 and objects.A.rect.y>settings.Allowed[7]-objects.A.height-50 and objects.A.rect.y<settings.Allowed[7]+46)) :
			objects.A.rect.y+=1
			#A.imgchange('marioback.png')
